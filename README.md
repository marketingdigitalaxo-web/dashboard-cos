...
Crea un repositorio nuevo en GitHub (puede ser público — GitHub Pages
...
Copia el email de la cuenta de servicio (dentro del JSON, campo
...
Abre tu Google Sheets (el mismo que llena `Codigo.gs`).
Botón Compartir → pega el email de la cuenta de servicio → dale
